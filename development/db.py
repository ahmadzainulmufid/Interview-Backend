...
class InterviewSession(db.Model):
    ...
    level = db.Column(db.String(50), nullable=False)         # Junior / Mid / Senior
...
class InterviewQuestion(db.Model):
    ...
    stage = db.Column(db.String(50))  # Opening / Technical / Study Case
    difficulty_level = db.Column(db.Integer)  # 1 / 2 / 3
...
class InterviewAnswer(db.Model):
    ...
    status = db.Column(db.String(20))  # Good / Average / Bad
